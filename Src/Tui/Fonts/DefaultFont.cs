...
public class DefaultFont : IAsciiFont {
    ...
    public virtual void PlaceString(
        ...
        if (bounds.SizeX <= 0 || bounds.SizeY <= 0)
            return;
        ...
        for (int l = 0; l < lines.Length; l++) {
            ...
            canvas.Style(new Area2D(new Point2D(x, y), new Size2D(s.Length, 1)), style);
    ...
    public Size2D GetMinSize(string str) {
        ...
        return new Size2D(maxLength, lineCount);
    }
