...
using static NeoKolors.Tui.Fonts.V2.Serialization.Xml.AutoCompoundApplicableGroup;
using ApplicableGroup = NeoKolors.Tui.Fonts.V2.Serialization.Xml.AutoCompoundApplicableGroup;
