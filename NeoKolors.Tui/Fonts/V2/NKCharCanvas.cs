...
public class NKCharCanvas : ICharCanvas {
    ...
    private readonly FixedOriginList2D<char?> _canvas = new();
    ...
    public void PlaceGlyph(int x, int y, IGlyph glyph) 
        => _canvas.Place(glyph.Glyph, new System.Drawing.Point(x, y));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void PlaceCanvas(int x, int y, ICharCanvas canvas) 
        => _canvas.Place(canvas.GetChars(), new System.Drawing.Point(x, y));
