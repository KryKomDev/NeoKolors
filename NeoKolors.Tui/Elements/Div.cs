...
public class Div : IElement {
    ...
    protected void RenderBlock(Rectangle rect) {
        ...
        foreach (var e in Content) {
            ...
            if (y + height + 1 >= rect.HigherY) {
                e.Render(new Rectangle(rect.LowerX, y, rect.HigherX, rect.HigherY));
                break;
            }

            e.Render(new Rectangle(rect.LowerX, y, rect.HigherX, y + height - 1));
            y += height;
        }
    }
    ...
    protected void RenderList(Rectangle rect) {
        ...
        foreach (var e in Content) {
            ...
            if (rect.Contains(rect.LowerX, y + yOffset)) {
            ...
            if (y + height > rect.HigherY) {
                e.Render(new Rectangle(rect.LowerX + contentOffset, y, rect.HigherX, rect.HigherY));
                break;
            }

            e.Render(new Rectangle(rect.LowerX + contentOffset, y, rect.HigherX, y + height - 1));
            y += height;
        }
    }
