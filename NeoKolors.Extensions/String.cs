...
public static class String {
    ...
    public static int GetPlainLength(this string text) =>
    ...
    public static string[] Chop(this string s, int maxLength) {
        ...
        ThrowHelper.ArgOutOfRange.ThrowIf(maxLength <= 0, nameof(maxLength), "Maximum length must be positive");
    ...
    public static string ToRoman(this int number, bool lowercase = false) {
        ThrowHelper.ArgOutOfRange.ThrowIf(number is < 1 or > 3999, nameof(number));
